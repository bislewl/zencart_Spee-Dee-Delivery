...
// class methods
        ...
        function install() {
            ...
            $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Fuel Surcharge Rate - Automatic Update', 'MODULE_SHIPPING_SPEEDEE_FUEL_SURCHARGE_AUTO_UPDATE', 'True', 'Auto Update Fuel Surcharge', '6', '6', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
            ...
            $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Version', 'MODULE_SHIPPING_SPEEDEE_VERSION', '1.1.4', 'SpeeDee Delivery Module Version', '6', '99', now())");
        }
